...
- **[Create a workflow](develop/create.md):** Add the artifact, give it an input type, and design its steps on the diagram.
- **[Start a workflow](develop/start.md):** Launch a run from a service or an automation, and keep the ID that identifies it.
...
- **[Await human task](develop/await-human-task.md):** Pause for role-based human decisions and external data, for as long as it takes.

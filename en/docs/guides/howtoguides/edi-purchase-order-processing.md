...
:::tip
For standard EDIFACT D03A message types you can skip the schema generation entirely and import a [prebuilt EDIFACT package](../../reference/data-formats/edi.md#prebuilt-edifact-packages) instead. This guide generates its own, because part 2 adjusts the schema for a partner that deviates from the standard — which is the common case in practice.

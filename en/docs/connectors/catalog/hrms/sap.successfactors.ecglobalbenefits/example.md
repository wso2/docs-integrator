...
Build an integration that connects to SAP SuccessFactors Employee Central and retrieves benefit employee claim records through the SAP SuccessFactors Employee Central Global Benefits connector. The integration exposes an automation entry point that calls the operation and stores the result in a variable you can process further.

**Operations used:**
- **List Benefit Employee Claims** : Queries the BenefitEmployeeClaim collection and returns a page of entities, optionally filtered, sorted, and paged through OData query options.

## Architecture

```mermaid
flowchart LR
    A((User)) --> B[List Benefit Employee Claims]
    B --> C[SAP SuccessFactors Employee Central Global Benefits Connector]
...
## Setting up the SAP SuccessFactors Employee Central Global Benefits integration

> **New to WSO2 Integrator?** Follow the [Create a New Integration](../../../../develop/create-integrations/create-a-new-integration.md) guide to set up your integration first, then return here to add the connector.

## Adding the SAP SuccessFactors Employee Central Global Benefits connector
...
## Configuring the SAP SuccessFactors Employee Central Global Benefits List Benefit Employee Claims operation
...
### Step 7: Expand the connection and configure the List Benefit Employee Claims operation

1. Select the **+** icon between **Start** and **Error Handler**.
2. Expand **ecglobalbenefitsClient** to display its operations.

![SAP SuccessFactors Employee Central Global Benefits connection expanded to display operations before selection](/img/connectors/catalog/hrms/sap.successfactors.ecglobalbenefits/ballerinax_sap_successfactors_ecglobalbenefits_screenshot_04_node_panel.png)
...
![SAP SuccessFactors Employee Central Global Benefits List Benefit Employee Claims operation configured before saving](/img/connectors/catalog/hrms/sap.successfactors.ecglobalbenefits/ballerinax_sap_successfactors_ecglobalbenefits_screenshot_05_operation_config.png)

4. Select **Save**. The operation step appears in the automation flow between **Start** and **Error Handler**.

![Completed SAP SuccessFactors Employee Central Global Benefits flow with the configured List Benefit Employee Claims operation](/img/connectors/catalog/hrms/sap.successfactors.ecglobalbenefits/ballerinax_sap_successfactors_ecglobalbenefits_screenshot_06_completed_flow.png)

## Try it yourself

Try this sample in WSO2 Integration Platform.

[![Deploy to Devant](https://openindevant.choreoapps.dev/images/DeployDevant-White.svg)](https://console.devant.dev/new?gh=wso2/integration-samples/tree/main/integrator-default-profile/connectors/ecglobalbenefits_connector_sample)

[View source on GitHub](https://github.com/wso2/integration-samples/tree/main/integrator-default-profile/connectors/ecglobalbenefits_connector_sample)

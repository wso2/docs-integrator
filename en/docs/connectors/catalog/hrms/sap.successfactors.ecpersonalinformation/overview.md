...
title: "SAP SuccessFactors Employee Central Personal Information"
...
The connector exposes a single client for all ecpersonalinformation operations against the SAP SuccessFactors OData v2 API.

| Client | Actions |
|--------|---------|
| `Client` | PerEmergencyContacts, PerPhone, PersonKey, PerPersonal, PerSocialAccount, PerPerson, PerPersonRelationship, PerEmail, HrisEmergencyContactAddressDEFLT, PerNationalId, and more |
...
* **[Example](example.md)**: Learn how to build and configure an integration using the **SAP SuccessFactors Employee Central Personal Information** connector, including connection setup, operation configuration, and execution flow.
...
* [SAP SuccessFactors Employee Central Personal Information Connector GitHub repository](https://github.com/ballerina-platform/module-ballerinax-sap.successfactors.employeecentral)

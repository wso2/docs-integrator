...
1. Enter `sap.successfactors.ecemployeeprofile` in the search field.
...
![SAP SuccessFactors Employee Central Employee Profile connection expanded to display operations before selection](/img/connectors/catalog/hrms/sap.successfactors.ecemployeeprofile/ballerinax_sap_successfactors_ecemployeeprofile_screenshot_04_node_panel.png)
...
- **Result** : Name of the variable that stores the returned Background_Community records — leave the default value, `ecemployeeprofileWrapper`.

![SAP SuccessFactors Employee Central Employee Profile List Background Communities operation configured before saving](/img/connectors/catalog/hrms/sap.successfactors.ecemployeeprofile/ballerinax_sap_successfactors_ecemployeeprofile_screenshot_05_operation_config.png)

4. Select **Save**. The operation step appears in the automation flow between **Start** and **Error Handler**.

![Completed SAP SuccessFactors Employee Central Employee Profile flow with the configured List Background Communities operation](/img/connectors/catalog/hrms/sap.successfactors.ecemployeeprofile/ballerinax_sap_successfactors_ecemployeeprofile_screenshot_06_completed_flow.png)

...
description: "Overview of the ballerinax/sap.successfactors.ecglobalassignment connector for WSO2 Integrator."
---

[SAP SuccessFactors Employee Central](https://www.sap.com/products/hcm/core-hr-payroll.html) is a comprehensive human capital management solution that helps organizations manage their workforce effectively. The `ballerinax/sap.successfactors.ecglobalassignment` connector provides access to Employee Central data through the SAP SuccessFactors OData v2 API. You can use these APIs to manage the assignment information of the employees who are assigned to another company within the organization.

...
![SAP SuccessFactors Employee Central Apprentice Management connection expanded to display operations before selection](/img/connectors/catalog/hrms/sap.successfactors.ecapprenticemanagement/ballerinax_sap_successfactors_ecapprenticemanagement_screenshot_04_operations_panel.png)
...
![Completed SAP SuccessFactors Employee Central Apprentice Management flow with the configured operation](/img/connectors/catalog/hrms/sap.successfactors.ecapprenticemanagement/ballerinax_sap_successfactors_ecapprenticemanagement_screenshot_06_completed_flow.png)

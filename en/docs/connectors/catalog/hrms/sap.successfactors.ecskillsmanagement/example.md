...
![SAP SuccessFactors Employee Central Skills Management connector palette open before selection](/img/connectors/catalog/hrms/sap.successfactors.ecskillsmanagement/ballerinax_sap_successfactors_ecskillsmanagement_screenshot_01_palette.png)
...
![SAP SuccessFactors Employee Central Skills Management connection form with all parameters bound before saving](/img/connectors/catalog/hrms/sap.successfactors.ecskillsmanagement/ballerinax_sap_successfactors_ecskillsmanagement_screenshot_02_connection_form.png)

### Step 4: Save the connection

Select **Save Connection** and verify that **ecskillsmanagementClient** appears in the **Connections** section.

![SAP SuccessFactors Employee Central Skills Management connection visible after saving](/img/connectors/catalog/hrms/sap.successfactors.ecskillsmanagement/ballerinax_sap_successfactors_ecskillsmanagement_screenshot_03_connections_list.png)
...
![SAP SuccessFactors Employee Central Skills Management connection expanded to display operations before selection](/img/connectors/catalog/hrms/sap.successfactors.ecskillsmanagement/ballerinax_sap_successfactors_ecskillsmanagement_screenshot_04_operations_panel.png)
...
- **Result** : Name of the variable that stores the returned CertificationContent records.

![SAP SuccessFactors Employee Central Skills Management List Certification Contents operation with all values entered before saving](/img/connectors/catalog/hrms/sap.successfactors.ecskillsmanagement/ballerinax_sap_successfactors_ecskillsmanagement_screenshot_05_operation_form.png)

4. Select **Save**. The operation step appears in the automation flow between **Start** and **Error Handler**.

![Completed SAP SuccessFactors Employee Central Skills Management flow with the configured operation](/img/connectors/catalog/hrms/sap.successfactors.ecskillsmanagement/ballerinax_sap_successfactors_ecskillsmanagement_screenshot_06_completed_flow.png)

...
1. Enter `sap.successfactors.ecskillsmanagement` in the search field.
...
![SAP SuccessFactors Employee Central Skills Management connection expanded to display operations before selection](/img/connectors/catalog/hrms/sap.successfactors.ecskillsmanagement/ballerinax_sap_successfactors_ecskillsmanagement_screenshot_04_node_panel.png)
...
![SAP SuccessFactors Employee Central Skills Management List Certification Contents operation configured before saving](/img/connectors/catalog/hrms/sap.successfactors.ecskillsmanagement/ballerinax_sap_successfactors_ecskillsmanagement_screenshot_05_operation_config.png)

4. Select **Save**. The operation step appears in the automation flow between **Start** and **Error Handler**.

![Completed SAP SuccessFactors Employee Central Skills Management flow with the configured List Certification Contents operation](/img/connectors/catalog/hrms/sap.successfactors.ecskillsmanagement/ballerinax_sap_successfactors_ecskillsmanagement_screenshot_06_completed_flow.png)

...
```mermaid
flowchart LR
    A((User)) --> B[List Adv Lines]
    B --> C[Microsoft Dynamics 365 Finance Receivable Connector]
...
![Microsoft Dynamics 365 Finance Receivable connector palette open before selection](/img/connectors/catalog/erp-business/microsoft.dynamics365.finance.receivable/ballerinax_microsoft_dynamics365_finance_receivable_screenshot_01_palette.png)
...
![Microsoft Dynamics 365 Finance Receivable connection visible after saving](/img/connectors/catalog/erp-business/microsoft.dynamics365.finance.receivable/ballerinax_microsoft_dynamics365_finance_receivable_screenshot_03_connections_list.png)
...
![Microsoft Dynamics 365 Finance Receivable connection expanded to display operations before selection](/img/connectors/catalog/erp-business/microsoft.dynamics365.finance.receivable/ballerinax_microsoft_dynamics365_finance_receivable_screenshot_04_operations_panel.png)

3. Select **List Adv Lines**. This operation has no required parameters, so the default result variable name is sufficient.

![Microsoft Dynamics 365 Finance Receivable List Adv Lines operation with all values entered before saving](/img/connectors/catalog/erp-business/microsoft.dynamics365.finance.receivable/ballerinax_microsoft_dynamics365_finance_receivable_screenshot_05_operation_form.png)
...
![Completed Microsoft Dynamics 365 Finance Receivable flow with the configured operation](/img/connectors/catalog/erp-business/microsoft.dynamics365.finance.receivable/ballerinax_microsoft_dynamics365_finance_receivable_screenshot_06_completed_flow.png)

## Try it yourself

Try this sample in WSO2 Integration Platform.

[![Deploy to Devant](https://openindevant.choreoapps.dev/images/DeployDevant-White.svg)](https://console.devant.dev/new?gh=wso2/integration-samples/tree/main/integrator-default-profile/connectors/microsoft_dynamics365_finance_receivable_connector_sample)

[View source on GitHub](https://github.com/wso2/integration-samples/tree/main/integrator-default-profile/connectors/microsoft_dynamics365_finance_receivable_connector_sample)

...
4. Remove the following files from `docs-bi/en/` in your `https://github.com/wso2/docs-bi` clone.
...
5. Copy the the new files back to your `docs-bi` clone from the `mkdocs-material` clone you built at step 3.

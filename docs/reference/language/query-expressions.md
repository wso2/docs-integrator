...
```ballerina
table key(id) empTable = table key(id) from var emp in employees
                                   select emp
...
- [Data Mapper](../../develop/integration-artifacts/supporting/data-mapper/data-mapper.md) -- Visual data transformation

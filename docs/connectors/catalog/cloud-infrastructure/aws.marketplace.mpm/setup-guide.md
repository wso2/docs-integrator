...
2. Navigate to **IAM** > **Users** and select **Create user**.
3. Enter a user name (for example, `marketplace-metering-user`).
...
3. Confirm the metering dimensions configured for your product match the dimension strings you plan to submit in usage records.

...
2. Select **New** and enter a **System ID** (e.g., `BALLERINA_INTEGRATION`) and a **System Name**.
3. Under **Technical Data**, set the **Host Name** to the hostname of your integration system.
4. Under **Users for Inbound Communication**, select **+** to add the communication user you created in the previous step.
5. Select **Save**.

...
| Command | Description |
|---------|-------------|
| `bal run --debug  <BAL_FILE_OR_PACKAGE>` | Debug a Ballerina package or file |
| `bal run --debug  <JAR_FILE>` | Debug a Ballerina executable JAR |
| `bal test --debug  ` | Debug Ballerina tests |
